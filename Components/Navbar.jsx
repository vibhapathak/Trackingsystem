                    ...
                    <div className="md:hidden">
                        ...
                        >
                            ...
                            <ul className="justify-center items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                                ...
                                <div className="flex-1 gap-x-6 items-center justify-end mt-6
                                space-y-6 md:flex md;space-y-0 md:mt-0">
                                {currentUser? (
                                    ...
                                    className="flex items-center justify-center gap-x-1 py-1 px-4 text-white font-medium bg-gray-800 hover:bg-gray-900 rounded-full md:inline-flex">
                                        CONNECT WALLET 
                                        <Nav3/>
                                        </button>
